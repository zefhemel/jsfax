...
public class JsfaxParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Jsfax");
  ...
  { 
    try
    { 
      InputStream descriptorStream = JsfaxParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = JsfaxParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(JsfaxParseController.class);
    }
  ...
  { 
    return JsfaxParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
